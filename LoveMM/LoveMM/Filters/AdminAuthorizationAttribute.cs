...
{
    public class AdminAuthorizationAttribute : FilterAttribute, IAuthorizationFilter
    {
        ...
        public AdminAuthorizationAttribute(String authUrl)
            : this()
        {
            this._AuthUrl = authUrl;
        }
        ...
        public AdminAuthorizationAttribute(String authUrl, String saveKey)
            : this(authUrl)
        {
        ...
        public AdminAuthorizationAttribute(String authUrl, String saveKey, String saveType)
        ...
        /// <summary>
        /// 获取或者设置一个值，该值表示登录地址
        /// 如果web.config中末定义AuthUrl的值，则默认为：/admin/login
        /// </summary>
